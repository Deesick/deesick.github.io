...
<aside class="prompt prompt--info" role="note" aria-label="info message">
  <span class="prompt__icon" aria-hidden="true">ℹ</span>
  <div class="prompt__body">An example showing the info type prompt.</div>
</aside>
